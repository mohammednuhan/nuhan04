    ...
    data: [
      {
        ...
        tag: "Team Sport",
        description:
          "State-level football player with experience in Karnataka State-level tournaments and inter-district championships. Developed leadership, strategic thinking, and elite fitness through competitive play at the state level.",
        icon: "football",
        level: 92,
        levelLabel: "State-Level Player",
        order: 1,
      },
      {
        title: "1500m Race",
        tag: "Track & Field",
        description:
          "Competed in 1500m distance events at state and district level athletics meets. Built mental toughness, stamina, and the ability to perform under high-pressure competitive conditions.",
        icon: "running",
        level: 82,
        levelLabel: "State-Level Athlete",
        order: 2,
      },
      {
        title: "4x400m Relay",
        tag: "Track & Field",
        description:
          "State-level relay team member. Mastered the art of trust, precise timing, and seamless baton handoffs — contributed to podium finishes at state-level athletics competitions.",
        icon: "relay",
        level: 88,
        levelLabel: "State-Level Relay",
        order: 3,
      },
    ],
  });
